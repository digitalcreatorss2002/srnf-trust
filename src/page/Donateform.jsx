      ...
      {!showPayment ? (
        <form className="space-y-5" onSubmit={handleSaveInformation}>
          ...
          <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
            <input type="checkbox" name="wants_80g" id="80g" className="w-5 h-5 accent-[#006D5B]" checked={formData.wants_80g} onChange={handleChange} />
          ...
          <button type="submit" disabled={isCreatingDonation} className="w-full bg-[#006D5B] hover:bg-[#C05621] text-white font-bold py-4 rounded-full transition shadow-lg text-lg cursor-pointer">
