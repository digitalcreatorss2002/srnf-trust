...
const Whowe = () => {
  ...
  return (
    <section 
      className="w-full min-h-screen py-16 px-4 md:px-12 lg:px-24 bg-gray-100 flex flex-col items-center" 
      style={{ backgroundImage: paperPattern, backgroundAttachment: 'fixed' }}
    >
      {/* 1. Overall Heading */}
      <h1 className="text-4xl md:text-5xl font-extrabold text-gray-950 mb-8 tracking-tight">
        Who We Are
      </h1>

      {/* 2. Top Corrected Paragraph */}
      <p className="max-w-4xl text-center text-lg md:text-xl text-gray-800 font-medium leading-relaxed mb-12">
