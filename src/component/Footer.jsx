...
const Footer = () => {
  return (
    <footer className="bg-[#fff] text-[#006D5B] font-sans mt-auto">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 items-start text-left">
          ...
          <div className="space-y-6 flex flex-col justify-start items-start text-left">
            <p
              className="text-[#006D5B]/95 text-2xl md:text-[22px] leading-relaxed max-w-[380px] text-left font-normal"
              style={{
            ...
            <div className="flex space-x-3 pt-2">
              <a
                href="#"
                className="bg-[#006D5B]/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#006D5B]/20 hover:scale-105 transition-all font-bold text-sm"
              >
                f
              </a>
              <a
                href="#"
                className="bg-[#006D5B]/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#006D5B]/20 hover:scale-105 transition-all text-sm"
              >
                𝕏
              </a>
              <a
          ...
          <div className="flex flex-col items-start text-left w-full">
            <h4 className="text-xl font-bold mb-6 border-b-2 border-[#006D5B]/20 w-fit pb-1.5 tracking-wide text-left heading-font">
              Quick Links
            </h4>
            <ul className="space-y-3 text-[16px] font-medium text-[#006D5B]/90 text-left w-full">
          ...
          <div className="flex flex-col items-start text-left w-full">
            ...
            <ul className="space-y-3 text-[15px] font-medium text-[#006D5B]/90 text-left w-full">
          ...
          <div className="flex flex-col items-start text-left w-full">
            ...
            <ul className="space-y-5 text-[14px] font-medium text-[#006D5B]/95 leading-relaxed text-left w-full">
